...
# possible issue
'''
File in the same directory but the program runs in different directory.
possible solve: suggest user if the file is inside any folder
'''
...
content_id = "content"
render_templates(template, target_files, content_id)